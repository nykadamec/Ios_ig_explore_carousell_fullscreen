...
(function(){
  ...
  const VERSION = '0.1.68-ios';  const ON_IOS = true; // čistě iOS režim + Debug UI modul + Enhanced Console + IGFS Module Load Monitor + Module Loading Fix + UI ToggleBtn Scope Fix
